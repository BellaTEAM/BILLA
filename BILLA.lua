...
if not Devhemo:get(Server.."IdBILLA") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
Devhemo:set(Server.."IdBILLA",DevId) 
else 
print('\27[1;31m⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺') 
end 
os.execute('lua BILLA.lua') 
end 
if not Devhemo:get(Server.."TokenBILLA") then 
...
Devhemo:set(Server.."TokenBILLA",TokenBot) 
end  
else 
...
Config = {
DevId = Devhemo:get(Server.."IdBILLA"),
TokenBot = Devhemo:get(Server.."TokenBILLA"),
BILLA = Devhemo:get(Server.."TokenBILLA"):match("(%d+)"),
SudoIds = {Devhemo:get(Server.."IdBILLA")},
}
Create(Config, "./config.lua") 
file = io.open("BILLA.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/BILLA
token="]]..Devhemo:get(Server.."TokenBILLA")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺ ≈ ⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺ ≈ ┉ ≈ ┉"
...
./tg -s ./BILLA.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
local Load_BILLA = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
Devhemo:del(Server.."IdBILLA");Devhemo:del(Server.."TokenBILLA")
end 
...
NameBot = (Devhemo:get(BILLA..'hemo:NameBot') or 'بيلاا')
--     Source BILLA     --
...
local Status = Devhemo:sismember(BILLA..'hemo:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(BILLA) then  
var = true  
end  
return var  
end 
...
local Status = Devhemo:sismember(BILLA..'hemo:SudoBot:',msg.sender_user_id_) 
...
local Status = Devhemo:sismember(BILLA..'hemo:ManagerAll:',msg.sender_user_id_) 
...
local Status = Devhemo:sismember(BILLA..'hemo:AdminAll:',msg.sender_user_id_) 
...
------ Vip Member All ------
function VipAll(msg) 
local Status = Devhemo:sismember(BILLA..'hemo:VipAll:',msg.sender_user_id_) 
...
local Status = Devhemo:sismember(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
local Status = Devhemo:sismember(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = Devhemo:sismember(BILLA..'hemo:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = Devhemo:sismember(BILLA..'hemo:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = Devhemo:sismember(BILLA..'hemo:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = Devhemo:sismember(BILLA..'hemo:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = Devhemo:sismember(BILLA..'hemo:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
if Devhemo:sismember(BILLA..'hemo:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if Devhemo:sismember(BILLA..'hemo:BanAll:', user_id) then
var = true
else
var = false
end
...
if Devhemo:sismember(BILLA..'hemo:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if Devhemo:sismember(BILLA..'hemo:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source BILLA     --
function BILLAFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.BILLA and msg then
FilesText = plugin.BILLA(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= BILLA:lower() then 
...
local info_file = io.open('./'..BILLA..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
Devhemo:set(BILLA.."hemo:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
Devhemo:sadd(BILLA.."hemo:Groups",IdGps) 
Devhemo:set(BILLA.."hemo:Lock:Bots"..IdGps,"del") Devhemo:hset(BILLA.."hemo:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
Devhemo:set(BILLA..Lock..IdGps,true)
end
if v.hemoConstructors then
for k,IdhemoConstructors in pairs(v.hemoConstructors) do
Devhemo:sadd(BILLA..'hemo:hemoConstructor:'..IdGps,IdhemoConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
Devhemo:sadd(BILLA..'hemo:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
Devhemo:sadd(BILLA..'hemo:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
Devhemo:sadd(BILLA..'hemo:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
Devhemo:sadd(BILLA..'hemo:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
Devhemo:sadd(BILLA..'hemo:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
Devhemo:set(BILLA.."hemo:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
Devhemo:set(BILLA.."hemo:Groups:Welcomes"..IdGps,v.Welcomes)   
...
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1914327324) then EngineerSource = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(BILLA) then EngineerSource = 'البوت' elseif SudoId(user_id) then EngineerSource = 'المطور الاساسي' elseif Devhemo:sismember(BILLA..'hemo:SecondSudo:', user_id) then EngineerSource = 'المطور الثانوي' elseif Devhemo:sismember(BILLA..'hemo:SudoBot:', user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:SudoBot:Rd"..chat_id) or 'المطور' elseif Devhemo:sismember(BILLA..'hemo:ManagerAll:', user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:Managers:Rd"..chat_id) or 'المدير العام' elseif Devhemo:sismember(BILLA..'hemo:AdminAll:', user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:Admins:Rd"..chat_id) or 'الادمن العام' elseif Devhemo:sismember(BILLA..'hemo:VipAll:', user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:VipMem:Rd"..chat_id) or 'المميز العام' elseif Devhemo:sismember(BILLA..'hemo:hemoConstructor:'..chat_id, user_id) then EngineerSource = 'المالك' elseif Devhemo:sismember(BILLA..'hemo:BasicConstructor:'..chat_id, user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif Devhemo:sismember(BILLA..'hemo:Constructor:'..chat_id, user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:Constructor:Rd"..chat_id) or 'المنشئ' elseif Devhemo:sismember(BILLA..'hemo:Managers:'..chat_id, user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:Managers:Rd"..chat_id) or 'المدير' elseif Devhemo:sismember(BILLA..'hemo:Admins:'..chat_id, user_id) then EngineerSource = Devhemo:get(BILLA.."hemo:Admins:Rd"..chat_id) or 'الادمن' elseif Devhemo:sismember(BILLA..'hemo:VipMem:'..chat_id, user_id) then  EngineerSource = Devhemo:get(BILLA.."hemo:VipMem:Rd"..chat_id) or 'المميز' elseif Devhemo:sismember(BILLA..'hemo:Cleaner:'..chat_id, user_id) then  EngineerSource = Devhemo:get(BILLA.."hemo:Cleaner:Rd"..chat_id) or 'المنظف' else EngineerSource = Devhemo:get(BILLA.."hemo:mem:Rd"..chat_id) or 'العضو' end return EngineerSource end
--     Source BILLA     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(BILLA) then  
var = true  
elseif Devhemo:sismember(BILLA..'hemo:SecondSudo:', user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:SudoBot:', user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:ManagerAll:', user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:AdminAll:', user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:VipAll:', user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:hemoConstructor:'..chat_id, user_id) then
var = true
elseif Devhemo:sismember(BILLA..'hemo:BasicConstructor:'..chat_id, user_id) then
var = true
elseif Devhemo:sismember(BILLA..'hemo:Constructor:'..chat_id, user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:Managers:'..chat_id, user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:Admins:'..chat_id, user_id) then
var = true  
elseif Devhemo:sismember(BILLA..'hemo:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local hemo = (BILLA..'hemo:Filters:'..msg.chat_id_)
if hemo then
...
--     Source BILLA     --
function hemomoned(chat_id, user_id, msg_id, text, offset, length) local tt = Devhemo:get(BILLA..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source BILLA     --
function ChCheck(msg)
local var = true 
if Devhemo:get(BILLA.."hemo:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..Devhemo:get(BILLA..'hemo:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if Devhemo:get(BILLA..'hemo:ChText') then
local ChText = Devhemo:get(BILLA..'hemo:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..Devhemo:get(BILLA.."hemo:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and Devhemo:get(BILLA..'yes'..data.sender_user_id_) == 'delyes' then
Devhemo:del(BILLA..'yes'..data.sender_user_id_, 'delyes')
Devhemo:del(BILLA..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and Devhemo:get(BILLA..'no'..data.sender_user_id_) == 'delno' then
Devhemo:del(BILLA..'yes'..data.sender_user_id_, 'delyes')
Devhemo:del(BILLA..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⇇◍⇉تم الغاء امر اطردني") 
end
--     Source BILLA     --
if DataText == '/yesdel' and Devhemo:get(BILLA..'yesdel'..data.sender_user_id_) == 'delyes' then
Devhemo:del(BILLA..'yesdel'..data.sender_user_id_, 'delyes')
Devhemo:del(BILLA..'nodel'..data.sender_user_id_, 'delno')
if Devhemo:sismember(BILLA..'hemo:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if Devhemo:sismember(BILLA..'hemo:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if Devhemo:sismember(BILLA..'hemo:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if Devhemo:sismember(BILLA..'hemo:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if Devhemo:sismember(BILLA..'hemo:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if Devhemo:sismember(BILLA..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if Devhemo:sismember(BILLA..'hemo:Constructor:'..data.chat_id_, data.sender_user_id_) or Devhemo:sismember(BILLA..'hemo:Managers:'..data.chat_id_, data.sender_user_id_) or Devhemo:sismember(BILLA..'hemo:Admins:'..data.chat_id_, data.sender_user_id_) or Devhemo:sismember(BILLA..'hemo:VipMem:'..data.chat_id_, data.sender_user_id_) or Devhemo:sismember(BILLA..'hemo:Cleaner:'..data.chat_id_, data.sender_user_id_) or Devhemo:sismember(BILLA..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
Devhemo:srem(BILLA..'hemo:Constructor:'..data.chat_id_,data.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Managers:'..data.chat_id_,data.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Admins:'..data.chat_id_,data.sender_user_id_)
Devhemo:srem(BILLA..'hemo:VipMem:'..data.chat_id_,data.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Cleaner:'..data.chat_id_,data.sender_user_id_)
Devhemo:srem(BILLA..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if Devhemo:get(BILLA.."hemo:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "⇇◍⇉تم الغاء امر تغير المطور الاساسي") 
Devhemo:del(BILLA.."hemo:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = Devhemo:get(BILLA.."hemo:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and Devhemo:get(BILLA..'nodel'..data.sender_user_id_) == 'delno' then
Devhemo:del(BILLA..'yesdel'..data.sender_user_id_, 'delyes')
Devhemo:del(BILLA..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "⇇◍⇉تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and Devhemo:get(BILLA.."hemo:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = Devhemo:smembers(BILLA..'hemo:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
Devhemo:incrby(BILLA..'hemo:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
Devhemo:del(BILLA..'hemo:ListRolet'..data.chat_id_) 
Devhemo:del(BILLA.."hemo:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "⇇◍⇉*صاحب الحظ* ↫ ["..UserName.."]\n⇇◍⇉*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
Devhemo:del(BILLA..'hemo:ListRolet'..data.chat_id_) 
Devhemo:del(BILLA.."hemo:NumRolet"..data.chat_id_..data.sender_user_id_) 
Devhemo:del(BILLA.."hemo:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if Devhemo:sismember(BILLA..'hemo:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
Devhemo:srem(BILLA..'hemo:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
Devhemo:del(BILLA..'hemo:Text:GpTexts'..Abbs..data.chat_id_)
Devhemo:srem(BILLA..'hemo:Manager:GpRedod'..data.chat_id_,Abbs)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Abbs = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = Devhemo:smembers(BILLA..'hemo:Text:GpTexts'..Abbs..data.chat_id_)
if Devhemo:get(BILLA..'hemo:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "⇇◍⇉تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Abbs) 
Devhemo:del(BILLA..'hemo:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
Devhemo:del(BILLA..'hemo:Text:GpTexts'..Abbs..data.chat_id_)
Devhemo:del(BILLA..'hemo:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
Devhemo:srem(BILLA..'hemo:Manager:GpRedod'..data.chat_id_,Abbs)
else
EditMsg(Chat_Id2, Msg_Id2, "⇇◍⇉عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = Devhemo:get(BILLA..'hemo:Help')
local Text = [[
...
local Help = Devhemo:get(BILLA..'hemo:Help1')
local Text = [[
...
local Help = Devhemo:get(BILLA..'hemo:Help2')
local Text = [[
⇇◍⇉اوامر الادمنيه ↫ ⤈
⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺
⇇◍⇉الاعدادت
...
local Help = Devhemo:get(BILLA..'hemo:Help3')
local Text = [[
⇇◍⇉اوامر المدراء ↫ ⤈
⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺
⇇◍⇉فحص البوت
...
local Help = Devhemo:get(BILLA..'hemo:Help4')
local Text = [[
⇇◍⇉اوامر المنشئين ↫ ⤈
⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺
⇇◍⇉تنزيل الكل
...
local Help = Devhemo:get(BILLA..'hemo:Help5')
local Text = [[
⇇◍⇉اوامر المطورين ↫ ⤈
⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺
⇇◍⇉الكروبات
...
if tonumber(Abbs) == tonumber(data.sender_user_id_) then
local Help = Devhemo:get(BILLA..'hemo:Help6')
local Text = [[
⇇◍⇉اوامر الاعضاء ↫ ⤈
⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺
...
if text and Devhemo:get(BILLA.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = Devhemo:get(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
Devhemo:del(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
Devhemo:del(BILLA.."Set:Cmd:Group:New"..msg.chat_id_)
Devhemo:srem(BILLA.."List:Cmd:Group:New"..msg.chat_id_,text)
...
Devhemo:del(BILLA.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(Devhemo:get(BILLA..'hemo:NameBot') or "بيلاا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(Devhemo:get(BILLA..'hemo:NameBot') or "بيلاا")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = Devhemo:get(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and Devhemo:get(BILLA.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
Devhemo:set(BILLA.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉ارسل الامر الجديد", 1, 'html')
Devhemo:del(BILLA.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
Devhemo:set(BILLA.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and Devhemo:get(BILLA.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = Devhemo:get(BILLA.."Set:Cmd:Group:New"..msg.chat_id_)
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الامر", 1, 'html')
Devhemo:del(BILLA.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = Devhemo:smembers(BILLA.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "⇇◍⇉قائمة الاوامر المضافه ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
Cmds = Devhemo:get(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = Devhemo:smembers(BILLA.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
Devhemo:del(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
Devhemo:del(BILLA.."List:Cmd:Group:New"..msg.chat_id_)
end
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حذف الاوامر المضافه في المجموعه", 1, 'html')
end
if text == "ترتيب الاوامر" then
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"ا")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"تك")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"م")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"اد")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"مد")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"من")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"اس")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
Devhemo:set(BILLA.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
Devhemo:sadd(BILLA.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
send(msg.chat_id_, msg.id_,"⇇◍⇉تم ترتيب الاوامر بالشكل التالي ↫ ⤈\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n⇇◍⇉ايدي ↫ ا\n⇇◍⇉تنزيل الكل ↫ تك\n⇇◍⇉رفع مميز ↫ م\n⇇◍⇉رفع ادمن ↫ اد \n⇇◍⇉رفع مدير ↫ مد \n⇇◍⇉رفع منشئ ↫ من \n⇇◍⇉رفع منشئ اساسي ↫ اس  \n⇇◍⇉تفعيل الايدي بالصوره ↫ تفع\n⇇◍⇉تعطيل الايدي بالصوره ↫ تعط\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺")  
end
if text == "اضف امر" or text == "اضافة امر" or text == "اضافه امر" and ChCheck(msg) then
Devhemo:set(BILLA.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉ارسل الامر القديم", 1, 'html')
return false
end
if text == "حذف امر" or text == "مسح امر" and ChCheck(msg) then 
Devhemo:set(BILLA.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = Devhemo:smembers(BILLA.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = Devhemo:get(BILLA.."Comd:New:rt:hemo:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = Devhemo:smembers(BILLA.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
Devhemo:del(BILLA.."Comd:New:rt:hemo:"..v..msg.chat_id_)
Devhemo:del(BILLA.."Coomds"..msg.chat_id_)
end
...
Devhemo:set(BILLA.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
Devhemo:sadd(BILLA.."Coomds"..msg.chat_id_,ComdNew)  
Devhemo:setex(BILLA.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n⇇◍⇉ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
Devhemo:del(BILLA.."Comd:New:rt:hemo:"..ComdNew..msg.chat_id_)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حذف الصلاحيه", 1, 'html')
end
if Devhemo:get(BILLA.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء الامر", 1, 'html')
Devhemo:del(BILLA.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = Devhemo:get(BILLA.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
Devhemo:set(BILLA.."Comd:New:rt:hemo:"..textn..msg.chat_id_,text)
...
if Devhemo:sismember(BILLA.."Coomds"..msg.chat_id_,DEV_ABBAS) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrhemo = Devhemo:get(BILLA.."Comd:New:rt:hemo:"..DEV_ABBAS..msg.chat_id_)
...
Devhemo:set(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS) 
Devhemo:sadd(BILLA..'hemo:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrhemo == "ادمن" and Admin(msg) then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
Devhemo:set(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)
Devhemo:sadd(BILLA..'hemo:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrhemo == "مدير" and Manager(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
Devhemo:set(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_ABBAS)  
Devhemo:sadd(BILLA..'hemo:Managers:'..msg.chat_id_, result.sender_user_id_)
...
Devhemo:srem(BILLA..'hemo:VipMem:'..msg.chat_id_, result.sender_user_id_)
Devhemo:del(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrhemo == "ادمن" and Admin(msg) then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
Devhemo:srem(BILLA..'hemo:Admins:'..msg.chat_id_, result.sender_user_id_)
Devhemo:del(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrhemo == "مدير" and Manager(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
Devhemo:srem(BILLA..'hemo:Managers:'..msg.chat_id_, result.sender_user_id_)
Devhemo:del(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrhemo == "عضو" then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
end
...
if Devhemo:sismember(BILLA.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrhemo = Devhemo:get(BILLA.."Comd:New:rt:hemo:"..text1[2]..msg.chat_id_)
if mrhemo == "مميز" and VipMem(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
Devhemo:sadd(BILLA..'hemo:VipMem:'..msg.chat_id_, result.id_)
Devhemo:set(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrhemo == "ادمن" and Admin(msg) then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
Devhemo:sadd(BILLA..'hemo:Admins:'..msg.chat_id_, result.id_)
Devhemo:set(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrhemo == "مدير" and Manager(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
Devhemo:sadd(BILLA..'hemo:Managers:'..msg.chat_id_, result.id_)
Devhemo:set(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrhemo == "عضو" then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
Devhemo:srem(BILLA..'hemo:VipMem:'..msg.chat_id_, result.id_)
Devhemo:del(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrhemo == "ادمن" and Admin(msg) then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
Devhemo:srem(BILLA..'hemo:Admins:'..msg.chat_id_, result.id_)
Devhemo:del(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrhemo == "مدير" and Manager(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
Devhemo:srem(BILLA..'hemo:Managers:'..msg.chat_id_, result.id_)
Devhemo:del(BILLA.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrhemo == "عضو" then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ba8lawa')..')'..' ❩\n⇇◍⇉تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
Devhemo:incr(BILLA..'hemo:UsersMsgs'..BILLA..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
Devhemo:incr(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
Devhemo:incr(BILLA..'hemo:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not Devhemo:sismember(BILLA.."hemo:Users",msg.chat_id_) then
Devhemo:sadd(BILLA.."hemo:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if not Devhemo:get(BILLA..'hemo:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=BILLA},function(arg,dp) 
local inline = {{{text="◍ اضفني في مجموعتك ◍",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
local start = Devhemo:get(BILLA.."hemo:Start:Bot")
if start then 
Start_Source = start
else
...
Devhemo:setex(BILLA..'hemo:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source BILLA     --
if not SecondSudo(msg) and not Devhemo:sismember(BILLA..'hemo:Ban:Pv',msg.sender_user_id_) and not Devhemo:get(BILLA..'hemo:Texting:Pv') then
...
Devhemo:sadd(BILLA..'hemo:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '⇇◍⇉العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n⇇◍⇉تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
Devhemo:srem(BILLA..'hemo:Ban:Pv',data.id_)  
return false  
end 
...
--     Source BILLA     --
if text and Devhemo:get(BILLA..'hemo:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ كليشة الستارت', 1, 'md')
Devhemo:del(BILLA..'hemo:Start:Bots'..msg.sender_user_id_) 
return false
end
Devhemo:set(BILLA.."hemo:Start:Bot",text)  
...
Devhemo:set(BILLA..'hemo:Start:Bots'..msg.sender_user_id_,true) 
...
Devhemo:del(BILLA..'hemo:Texting:Pv') 
end
if text == 'تعطيل التواصل' or text == '↫ تعطيل التواصل ◍' then  
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل التواصل بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Texting:Pv',true) 
end
end
--     Source BILLA     --
...
Devhemo:incr(BILLA..'hemo:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
Devhemo:set(BILLA.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = Devhemo:get(BILLA.."hemo:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
Devhemo:sadd(BILLA..'hemo:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(BILLA) then 
Devhemo:srem(BILLA.."hemo:Groups", msg.chat_id_) 
...
if Devhemo:get(BILLA..'hemo:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
Devhemo:incr(BILLA..'hemo:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
Devhemo:incr(BILLA..'hemo:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source BILLA     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not Devhemo:get(BILLA..'hemo:Lock:FreeBot'..BILLA) then
if ChatType == 'pv' then
...
Devhemo:sadd(BILLA..'hemo:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
Devhemo:srem(BILLA..'hemo:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
Devhemo:sadd(BILLA..'hemo:Admins:'..msg.chat_id_, admins[i].user_id_)
...
Devhemo:sadd(BILLA.."hemo:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
Devhemo:sadd(BILLA.."hemo:hemoConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
Devhemo:srem(BILLA.."hemo:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
Devhemo:srem(BILLA.."hemo:hemoConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if Devhemo:sismember(BILLA..'hemo:Groups',msg.chat_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(Devhemo:get(BILLA..'hemo:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉عدد اعضاء المجموعه اقل من ↫ *'..(Devhemo:get(BILLA..'hemo:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","⇇◍⇉تم تفعيل المجموعه "..dp.title_)  
Devhemo:sadd(BILLA.."hemo:Groups",msg.chat_id_)
Devhemo:sadd(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
Devhemo:set(BILLA.."hemo:Groups:Links"..msg.chat_id_,LinkGroup) 
...
Devhemo:set(BILLA..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source BILLA     --
local ReFalse = tostring(msg.chat_id_)
if not Devhemo:sismember(BILLA.."hemo:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if Devhemo:get(BILLA..'hemo:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
Devhemo:sadd(BILLA..'hemo:Tkeed:'..msg.chat_id_, dp.id_)
...
if Devhemo:get(BILLA.."hemo:Lock:Join"..msg.chat_id_) then
...
if not Manager(msg) then 
local filter = Devhemo:smembers(BILLA.."hemo:FilterPhoto"..msg.chat_id_)
...
if not Manager(msg) then 
local filter = Devhemo:smembers(BILLA.."hemo:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Manager(msg) then 
local filter = Devhemo:smembers(BILLA.."hemo:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = Devhemo:get(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = Devhemo:get(BILLA..'hemo:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
Devhemo:del(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
Devhemo:srem(BILLA..'hemo:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = Devhemo:get(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
Devhemo:del(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
Devhemo:srem(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = Devhemo:get(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
Devhemo:del(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Video:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:File:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Text:GpRed'..msg.content_.text_..msg.chat_id_)
Devhemo:srem(BILLA..'hemo:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = Devhemo:get(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
Devhemo:del(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_)
Devhemo:del(BILLA.."hemo:Gif:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Voice:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Audio:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Photo:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Stecker:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Video:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:File:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Text:AllRed"..msg.content_.text_)
Devhemo:del(BILLA.."hemo:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source BILLA     --
if text and text:match("^(.*)$") then
local SaveGpRedod = Devhemo:get(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = Devhemo:get(BILLA..'hemo:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = Devhemo:smembers(BILLA..'hemo:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉⇇◍⇉تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
Devhemo:del(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Text:GpTexts'..GetGpTexts..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
Devhemo:srem(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
Devhemo:sadd(BILLA..'hemo:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not Devhemo:get(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if Devhemo:sismember(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_,text) then
local EngineerSource =  Devhemo:smembers(BILLA..'hemo:Text:GpTexts'..text..msg.chat_id_)
Dev_hemo(msg.chat_id_, msg.id_, 1, '['..EngineerSource[math.random(#EngineerSource)]..']' , 1, 'md')  
end
end
--     Source BILLA     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = Devhemo:get(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = Devhemo:get(BILLA..'DelManagerRep'..msg.chat_id_)
Devhemo:srem(BILLA..'hemo:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ الرد', 1, 'md')
Devhemo:del(BILLA..'hemo:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
Devhemo:del(BILLA..'DelManagerRep'..msg.chat_id_)
return false
end
Devhemo:del(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = Devhemo:get(BILLA..'hemo:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then Devhemo:set(BILLA..'hemo:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then Devhemo:set(BILLA..'hemo:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then Devhemo:set(BILLA..'hemo:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then Devhemo:set(BILLA..'hemo:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then Devhemo:set(BILLA..'hemo:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
Devhemo:set(BILLA..'hemo:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then Devhemo:set(BILLA..'hemo:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
Devhemo:set(BILLA..'hemo:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not Devhemo:get(BILLA..'hemo:Lock:GpRed'..msg.chat_id_) then 
if Devhemo:get(BILLA..'hemo:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, Devhemo:get(BILLA..'hemo:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if Devhemo:get(BILLA..'hemo:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, Devhemo:get(BILLA..'hemo:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if Devhemo:get(BILLA..'hemo:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA..'hemo:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if Devhemo:get(BILLA..'hemo:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA..'hemo:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if Devhemo:get(BILLA..'hemo:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA..'hemo:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if Devhemo:get(BILLA..'hemo:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA..'hemo:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if Devhemo:get(BILLA..'hemo:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, Devhemo:get(BILLA..'hemo:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if Devhemo:get(BILLA..'hemo:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function EngineerSource(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = Devhemo:get(BILLA..'hemo:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = Devhemo:get(BILLA..'hemo:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = Devhemo:get(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = Devhemo:get(BILLA..'DelSudoRep')
Devhemo:del(BILLA.."hemo:Sudo:AllRed",DelSudoRep)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ الرد', 1, 'md')
Devhemo:del(BILLA.."hemo:Add:AllText"..msg.sender_user_id_)
Devhemo:del(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_)
Devhemo:del(BILLA.."DelSudoRep")
return false
end
Devhemo:del(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = Devhemo:get(BILLA.."hemo:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
Devhemo:set(BILLA.."hemo:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
Devhemo:set(BILLA.."hemo:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
Devhemo:set(BILLA.."hemo:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
Devhemo:set(BILLA.."hemo:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
Devhemo:set(BILLA.."hemo:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
Devhemo:set(BILLA.."hemo:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
Devhemo:set(BILLA.."hemo:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
Devhemo:set(BILLA.."hemo:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حفظ الرد الجديد', 1, 'md') 
Devhemo:del(BILLA.."hemo:Add:AllText"..msg.sender_user_id_)
Devhemo:del(BILLA..'DelSudoRep')
return false end end
if msg.content_.text_ and not Devhemo:get(BILLA..'hemo:Lock:AllRed'..msg.chat_id_) then
if Devhemo:get(BILLA.."hemo:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, Devhemo:get(BILLA.."hemo:Video:AllRed"..msg.content_.text_))
end
if Devhemo:get(BILLA.."hemo:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, Devhemo:get(BILLA.."hemo:File:AllRed"..msg.content_.text_))
end
if Devhemo:get(BILLA.."hemo:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA.."hemo:Voice:AllRed"..msg.content_.text_))
end
if Devhemo:get(BILLA.."hemo:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA.."hemo:Audio:AllRed"..msg.content_.text_))
end
if Devhemo:get(BILLA.."hemo:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA.."hemo:Photo:AllRed"..msg.content_.text_))
end
if  Devhemo:get(BILLA.."hemo:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, Devhemo:get(BILLA.."hemo:Gif:AllRed"..msg.content_.text_))
end
if Devhemo:get(BILLA.."hemo:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, Devhemo:get(BILLA.."hemo:Stecker:AllRed"..msg.content_.text_))
end
if Devhemo:get(BILLA.."hemo:Text:AllRed"..msg.content_.text_) then
function EngineerSource(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = Devhemo:get(BILLA..'hemo:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = Devhemo:get(BILLA.."hemo:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not Devhemo:sismember(BILLA..'hemo:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, msg.sender_user_id_) then
Devhemo:sadd(BILLA..'hemo:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source BILLA     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= BILLA then
floods = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(Devhemo:get(BILLA.."hemo:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
Devhemo:setex(BILLA.."hemo:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source BILLA     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(BILLA) then
Devhemo:set(BILLA..'hemo:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = Devhemo:get(BILLA..'hemo:PinnedMsg'..msg.chat_id_)
if pin_id and Devhemo:get(BILLA..'hemo:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if Devhemo:get(BILLA..'hemo:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
Devhemo:del(BILLA..'hemo:viewget'..msg.sender_user_id_)
else
...
if Devhemo:get(BILLA..'hemo:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if Devhemo:get(BILLA..'hemo:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if Devhemo:get(BILLA..'hemo:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if Devhemo:get(BILLA..'hemo:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if Devhemo:get(BILLA..'hemo:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if Devhemo:get(BILLA..'hemo:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if Devhemo:get(BILLA..'hemo:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if Devhemo:get(BILLA..'hemo:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if Devhemo:get(BILLA..'hemo:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if Devhemo:get(BILLA..'hemo:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if Devhemo:get(BILLA..'hemo:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source BILLA     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if Devhemo:get(BILLA..'hemo:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if Devhemo:get(BILLA..'hemo:Groups:Welcomes'..msg.chat_id_) then
Welcomes = Devhemo:get(BILLA..'hemo:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
...
if Devhemo:get(BILLA.."hemo:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source BILLA     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not Devhemo:get(BILLA..'hemo:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = BILLA,offset_ = 0,limit_ = 1},function(extra,abbas,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(BILLA) then 
if Devhemo:sismember(BILLA..'hemo:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n⇇◍⇉ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n⇇◍⇉بعد ذلك يرجى ارسال امر ↫ تفعيل\n⇇◍⇉سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if Devhemo:get(BILLA.."hemo:Text:BotWelcome") then hemoText = Devhemo:get(BILLA.."hemo:Text:BotWelcome") else hemoText = "⇇◍⇉مرحبا انا بوت اسمي "..NameBot.."\n⇇◍⇉حالة المجموعه ↫ "..BotText.."\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺" end 
if Devhemo:get(BILLA.."hemo:Photo:BotWelcome") then hemoPhoto = Devhemo:get(BILLA.."hemo:Photo:BotWelcome") elseif abbas.photos_[0] then hemoPhoto = abbas.photos_[0].sizes_[1].photo_.persistent_id_ else hemoPhoto = nil end 
...
if Devhemo:get(BILLA..'hemo:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source BILLA     --
...
if Devhemo:get(BILLA..'hemo:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if Devhemo:get(BILLA..'hemo:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if Devhemo:get(BILLA..'hemo:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if Devhemo:get(BILLA..'hemo:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if Devhemo:get(BILLA..'hemo:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if Devhemo:get(BILLA..'hemo:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not Devhemo:get(BILLA..'hemo:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(Devhemo:get(BILLA..'hemo:Spam:Text'..msg.chat_id_))
end
if Devhemo:get(BILLA..'hemo:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source BILLA     --
if Devhemo:get(BILLA.."hemo:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"⇇◍⇉تم الغاء حفظ الرابط")       
Devhemo:del(BILLA.."hemo:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
Devhemo:set(BILLA.."hemo:Groups:Links"..msg.chat_id_,Link)
...
if Devhemo:get('EngineerSource:'..BILLA.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Devhemo:del('EngineerSource:'..BILLA..'id:user'..msg.chat_id_)  
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء الامر', 1, 'md')
Devhemo:del('EngineerSource:'..BILLA.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
Devhemo:del('EngineerSource:'..BILLA.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = Devhemo:get('EngineerSource:'..BILLA..'id:user'..msg.chat_id_)  
Devhemo:incrby(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_hemo(msg.chat_id_, msg.id_,  1, "⇇◍⇉تم اضافة "..numadded..' رساله', 1, 'md')
Devhemo:del('EngineerSource:'..BILLA..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if Devhemo:get('EngineerSource:'..BILLA.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Devhemo:del('EngineerSource:'..BILLA..'ids:user'..msg.chat_id_)  
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء الامر', 1, 'md')
Devhemo:del('EngineerSource:'..BILLA.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
Devhemo:del('EngineerSource:'..BILLA.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = Devhemo:get('EngineerSource:'..BILLA..'ids:user'..msg.chat_id_)  
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not Devhemo:get(BILLA.."hemo:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if Devhemo:get(BILLA.."hemo:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","⇇◍⇉ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if Devhemo:get(BILLA.."hemo:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not Devhemo:get(BILLA.."hemo:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not Devhemo:get(BILLA.."hemo:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = Devhemo:smembers(BILLA..'hemo:Groups') 
local BotName = (Devhemo:get(BILLA.."hemo:NameBot") or 'بيلاا')
local GetJson = '{"BotId": '..BILLA..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = Devhemo:get(BILLA.."hemo:Groups:Links"..v)
Welcomes = Devhemo:get(BILLA..'hemo:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
hemoConstructors = Devhemo:smembers(BILLA..'hemo:hemoConstructor:'..v)
Constructors = Devhemo:smembers(BILLA..'hemo:BasicConstructor:'..v)
BasicConstructors = Devhemo:smembers(BILLA..'hemo:Constructor:'..v)
Managers = Devhemo:smembers(BILLA..'hemo:Managers:'..v)
Admis = Devhemo:smembers(BILLA..'hemo:Admins:'..v)
Vips = Devhemo:smembers(BILLA..'hemo:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..BILLA..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..BILLA..'.json', '⇇◍⇉يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..BILLA..'.json')
end
...
--     Source BILLA     --
if Devhemo:get(BILLA.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_hemo( msg.chat_id_, msg.id_, 1,"⇇◍⇉يوجد فقط ( 6 ) اختيارات\n⇇◍⇉ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = Devhemo:get(BILLA.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
Devhemo:del(BILLA.."SET:GAME"..msg.chat_id_)   
Dev_hemo( msg.chat_id_, msg.id_, 1,'⇇◍⇉*المحيبس باليد رقم* ↫ '..NUM..'\n⇇◍⇉*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if Devhemo:get(BILLA..'Devhemo4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "⇇◍⇉تم الغاء الامر")
Devhemo:del(BILLA..'Devhemo4'..msg.sender_user_id_)
return false  end 
Devhemo:del(BILLA..'Devhemo4'..msg.sender_user_id_)
...
Devhemo:set(BILLA..'hemo:ChId',data.id_)
else
...
--     Source BILLA     --
if Devhemo:get(BILLA.."hemo:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
Devhemo:del(BILLA.."hemo:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء الامر', 1, 'md')
return false 
end 
Devhemo:del(BILLA.."hemo:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
Devhemo:set(BILLA.."DevText", DevText)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ كليشة المطور", 1, "md")
end
if Devhemo:get(BILLA..'hemo:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
Devhemo:del(BILLA..'hemo:NameBot'..msg.sender_user_id_)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء الامر', 1, 'md')
return false 
end 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حفظ اسم البوت ', 1, 'html')
Devhemo:del(BILLA..'hemo:NameBot'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:NameBot', text)
return false 
end
--     Source BILLA     --
if text == "الرابط" then
if not Devhemo:get(BILLA.."hemo:Lock:GpLinks"..msg.chat_id_) then 
if Devhemo:get(BILLA.."hemo:Groups:Links"..msg.chat_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 ↬ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"..Devhemo:get(BILLA.."hemo:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
if text and text == (Devhemo:get(BILLA..'hemo:NameBot') or 'بيلاا') then 
NameBot = (Devhemo:get(BILLA..'hemo:NameBot') or 'بيلاا')
...
if tonumber((Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉لم تربح اي نقطه\n⇇◍⇉ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉عدد النقاط التي ربحتها ↫ '..(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then Devhemo:del(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then Devhemo:del(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حذف جميع نقاطك', 1, 'md') end
--     Source BILLA     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) then
if not Devhemo:get(BILLA..'hemo:Lock:Games'..msg.chat_id_) then
Devhemo2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum'..msg.chat_id_) and not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
EngineerSource = '⇇◍⇉مبروك لقد ربحت في اللعبه \n⇇◍⇉ارسل ↫ سمايلات للعب مره اخرى'
Dev_hemo(msg.chat_id_, msg.id_, 1,EngineerSource, 1, 'md')
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
Devhemo:set(BILLA..'hemo:Games:Ids'..msg.chat_id_,true)
end
...
if not Devhemo:get(BILLA..'hemo:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
Devhemo:set(BILLA.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
Devhemo:setex(BILLA.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum2'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum2'..msg.chat_id_) and not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
...
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum3'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum3'..msg.chat_id_) and not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
...
Devhemo2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum4'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
if text == Devhemo:get(BILLA..'hemo:GameNum4'..msg.chat_id_) and not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
...
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum5'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum5'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
Devhemo:del(BILLA..'hemo:GameNum5'..msg.chat_id_)
...
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum6'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum6'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
Devhemo:del(BILLA..'hemo:GameNum6'..msg.chat_id_)
...
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum7'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum7'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
Devhemo:del(BILLA..'hemo:GameNum7'..msg.chat_id_)
...
name = Devhemo2[math.random(#Devhemo2)]
Devhemo:set(BILLA..'hemo:GameNum8'..msg.chat_id_,name)
Devhemo:del(BILLA..'hemo:Games:Ids'..msg.chat_id_)
...
if text == Devhemo:get(BILLA..'hemo:GameNum8'..msg.chat_id_) then
if not Devhemo:get(BILLA..'hemo:Games:Ids'..msg.chat_id_) then 
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
Devhemo:del(BILLA..'hemo:GameNum8'..msg.chat_id_)
...
--     Source BILLA     --
if Devhemo:get(BILLA.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_hemo(msg.chat_id_, msg.id_, 1,"⇇◍⇉عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = Devhemo:get(BILLA.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
Devhemo:del(BILLA..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
Devhemo:del(BILLA.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉*التخمين الصحيح هو* ↫ '..NUM..'\n⇇◍⇉*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Devhemo:incrby(BILLA..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(Devhemo:get(BILLA..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
Devhemo:del(BILLA..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
Devhemo:del(BILLA.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉*التخمين الصحيح هو* ↫ '..GETNUM..'\n⇇◍⇉*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(Devhemo:get(BILLA..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(Devhemo:get(BILLA..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
Devhemo:set(BILLA.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n⇇◍⇉سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n⇇◍⇉ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
Devhemo:setex(BILLA.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source BILLA     --
if text == 'روليت' then
if not Devhemo:get(BILLA..'hemo:Lock:Games'..msg.chat_id_) then
Devhemo:del(BILLA.."hemo:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
Devhemo:del(BILLA..'hemo:ListRolet'..msg.chat_id_)  
Devhemo:setex(BILLA.."hemo:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and Devhemo:get(BILLA.."hemo:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "⇇◍⇉لا استطيع بدء اللعبه بلاعب واحد فقط"
else
Devhemo:set(BILLA.."hemo:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '⇇◍⇉تم بدء تسجيل اللسته يرجى ارسال المعرفات \n⇇◍⇉الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
Devhemo:del(BILLA.."hemo:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and Devhemo:get(BILLA.."hemo:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if Devhemo:sismember(BILLA..'hemo:ListRolet'..msg.chat_id_,text) then
...
Devhemo:sadd(BILLA..'hemo:ListRolet'..msg.chat_id_,text)
local CountAdd = Devhemo:get(BILLA.."hemo:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = Devhemo:scard(BILLA..'hemo:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
Devhemo:del(BILLA.."hemo:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
Devhemo:setex(BILLA.."hemo:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
Devhemo0 = (Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
Devhemo:incrby(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,Devhemo0)
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉تم بيع '..(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n⇇◍⇉كل نقطه تساوي 50 رساله', 'md')
Devhemo:del(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source BILLA     --
...
Devhemo:sadd(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,Manager_id)  
Devhemo:sadd(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if Devhemo:get(BILLA.."hemo:Left:Bot"..BILLA) and not SecondSudo(msg) then
...
local msguser = tonumber(Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(Devhemo:get(BILLA..'hemo:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
Devhemo:setex(BILLA..'Devhemo4'..msg.sender_user_id_,360,true)
...
function EngineerSource(extra,result,success)
if Devhemo:get(BILLA.."hemo:Send:Bot"..BILLA) and not SecondSudo(msg) then 
send(msg.chat_id_, msg.id_,"⇇◍⇉الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = Devhemo:smembers(BILLA.."hemo:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = Devhemo:smembers(BILLA.."hemo:Users")
...
Devhemo:set(BILLA..'hemo:viewget'..msg.sender_user_id_,true)
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ BILLA\n\n[⇇◍⇉  BILLA ᴄʜᴀɴɴᴇʟ](http://t.me/EE92i)\n\n[⇇◍⇉  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/EE28i)\n\n[⇇◍⇉  BILLA ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/SSSSSSY)\n\n[⇇◍⇉  BILLA ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/AAAAQAA)\n\n[⇇◍⇉  ʙᴏᴛ BILLA](http://t.me/ll_I_I)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⇇◍⇉ sᴏᴜʀᴄʀ BILLA',url="t.me/EE92i"}},
}
...
if Devhemo:get(BILLA.."hemo:Kick:Me"..msg.chat_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
Devhemo:set(BILLA..'yes'..msg.sender_user_id_, 'delyes')
Devhemo:set(BILLA..'no'..msg.sender_user_id_, 'delno')
...
Devhemo:set(BILLA.."hemo:Kick:Me"..msg.chat_id_, true)
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل امر اطردني'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
Devhemo:del(BILLA.."hemo:Kick:Me"..msg.chat_id_)
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل امر اطردني'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
end
--     Source BILLA     --
if text == "نزلني" and ChCheck(msg) then
if Devhemo:get(BILLA.."hemo:Del:Me"..msg.chat_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
Devhemo:set(BILLA..'yesdel'..msg.sender_user_id_, 'delyes')
Devhemo:set(BILLA..'nodel'..msg.sender_user_id_, 'delno')
...
Devhemo:set(BILLA.."hemo:Del:Me"..msg.chat_id_, true)
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل امر نزلني'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
Devhemo:del(BILLA.."hemo:Del:Me"..msg.chat_id_)
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل امر نزلني'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
end
--     Source BILLA     --
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:TagAll'..msg.chat_id_)
end
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not Devhemo:get(BILLA..'hemo:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "⇇◍⇉وينكم يالربع \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if Devhemo:get(BILLA..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..Devhemo:get(BILLA..'Save:UserName'..v.user_id_).."]\n"
else
...
local EntryNumber = (Devhemo:get(BILLA..'hemo:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (Devhemo:get(BILLA..'hemo:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (Devhemo:get(BILLA..'hemo:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(Devhemo:get(BILLA..'hemo:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = Devhemo:get(BILLA..'hemo:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then Devhemo:del(BILLA..'hemo:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then Devhemo:del(BILLA..'hemo:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source BILLA     --
...
if not Devhemo:get(BILLA..'hemo:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function EngineerSource(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(BILLA) then  
...
if Devhemo:sismember(BILLA.."hemo:hemoConstructor:"..msg.chat_id_,result.id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
...
if tonumber(result.sender_user_id_) == tonumber(BILLA) then 
Dev_hemo(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if Devhemo:sismember(BILLA.."hemo:hemoConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local EngineerSource = "صارر ستاذيي 🏃🏻‍♂️♥️" 
...
if Devhemo:sismember(BILLA..'hemo:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if Devhemo:sismember(BILLA..'hemo:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if Devhemo:sismember(BILLA..'hemo:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if Devhemo:sismember(BILLA..'hemo:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if Devhemo:sismember(BILLA..'hemo:VipAll:',result.sender_user_id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if Devhemo:sismember(BILLA..'hemo:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if Devhemo:sismember(BILLA..'hemo:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if Devhemo:sismember(BILLA..'hemo:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if Devhemo:sismember(BILLA..'hemo:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if Devhemo:sismember(BILLA..'hemo:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if Devhemo:sismember(BILLA..'hemo:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
Devhemo:srem(BILLA..'hemo:SecondSudo:', result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:SudoBot:', result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:ManagerAll:', result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:AdminAll:', result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:VipAll:', result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Constructor:'..msg.chat_id_,result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Managers:'..msg.chat_id_, result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Admins:'..msg.chat_id_, result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:VipMem:'..msg.chat_id_, result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if Devhemo:sismember(BILLA..'hemo:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if Devhemo:sismember(BILLA..'hemo:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if Devhemo:sismember(BILLA..'hemo:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if Devhemo:sismember(BILLA..'hemo:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if Devhemo:sismember(BILLA..'hemo:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
if Devhemo:sismember(BILLA..'hemo:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if Devhemo:sismember(BILLA..'hemo:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if Devhemo:sismember(BILLA..'hemo:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if Devhemo:sismember(BILLA..'hemo:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if Devhemo:sismember(BILLA..'hemo:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if Devhemo:sismember(BILLA..'hemo:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if hemoDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
Devhemo:srem(BILLA..'hemo:SecondSudo:', result.id_)
Devhemo:srem(BILLA..'hemo:SudoBot:', result.id_)
Devhemo:srem(BILLA..'hemo:ManagerAll:', result.id_)
Devhemo:srem(BILLA..'hemo:AdminAll:', result.id_)
Devhemo:srem(BILLA..'hemo:VipAll:', result.id_)
Devhemo:srem(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,result.id_)
Devhemo:srem(BILLA..'hemo:Constructor:'..msg.chat_id_,result.id_)
Devhemo:srem(BILLA..'hemo:Managers:'..msg.chat_id_, result.id_)
Devhemo:srem(BILLA..'hemo:Admins:'..msg.chat_id_, result.id_)
Devhemo:srem(BILLA..'hemo:VipMem:'..msg.chat_id_, result.id_)
Devhemo:srem(BILLA..'hemo:Cleaner:'..msg.chat_id_, result.id_)
elseif hemoDelAll(msg.sender_user_id_,msg.chat_id_) == 'secondsudo' then
Devhemo:srem(BILLA..'hemo:SudoBot:', result.id_)
Devhemo:srem(BILLA..'hemo:ManagerAll:', result.id_)
Devhemo:srem(BILLA..'hemo:AdminAll:', result.id_)
...
Devhemo:sadd(BILLA..'hemo:SecondSudo:',result.sender_user_id_)
...
if result.id_ then
Devhemo:sadd(BILLA..'hemo:SecondSudo:',result.id_)
...
Devhemo:sadd(BILLA..'hemo:SecondSudo:',user)
...
Devhemo:srem(BILLA..'hemo:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:SudoBot:',result.id_)
...
Devhemo:sadd(BILLA..'hemo:SudoBot:',user)
...
Devhemo:srem(BILLA..'hemo:SudoBot:',user)
...
Devhemo:sadd(BILLA..'hemo:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:ManagerAll:',result.id_)
...
Devhemo:sadd(BILLA..'hemo:ManagerAll:',user)
...
Devhemo:srem(BILLA..'hemo:ManagerAll:',user)
...
function raf_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:AdminAll:',result.id_)
...
Devhemo:sadd(BILLA..'hemo:AdminAll:',user)
...
Devhemo:srem(BILLA..'hemo:AdminAll:',user)
...
function raf_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:VipAll:',result.id_)
...
Devhemo:sadd(BILLA..'hemo:VipAll:',user)
...
Devhemo:srem(BILLA..'hemo:VipAll:',user)
...
function raf_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,result.id_)
...
Devhemo:sadd(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,result.sender_user_id_)
...
Devhemo:srem(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,result.id_)
...
Devhemo:srem(BILLA..'hemo:hemoConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,result.id_)
...
Devhemo:sadd(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:BasicConstructor:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:Constructor:'..msg.chat_id_,result.id_)
...
Devhemo:sadd(BILLA..'hemo:Constructor:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:Constructor:'..msg.chat_id_,user)
...
Devhemo:sadd(BILLA..'hemo:Managers:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:Managers:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
Devhemo:sadd(BILLA..'hemo:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
Devhemo:sadd(BILLA..'hemo:Cleaner:'..msg.chat_id_,result.id_)
...
Devhemo:sadd(BILLA..'hemo:Cleaner:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:Cleaner:'..msg.chat_id_,user)
...
function prom_reply(extra, result, success)
if not BasicConstructor(msg) and Devhemo:get(BILLA.."hemo:Lock:ProSet"..msg.chat_id_) then 
...
Devhemo:sadd(BILLA..'hemo:Admins:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:Admins:'..msg.chat_id_,user)
...
Devhemo:sadd(BILLA..'hemo:VipMem:'..msg.chat_id_,user)
...
Devhemo:srem(BILLA..'hemo:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..BILLA)
local GetInfo = JSON.decode(Check)
...
Devhemo:del(BILLA.."hemo:Lock:ProSet"..msg.chat_id_)
...
Devhemo:set(BILLA.."hemo:Lock:ProSet"..msg.chat_id_,"true")
...
if not Constructor(msg) and Devhemo:get(BILLA.."hemo:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
Devhemo:sadd(BILLA..'hemo:Ban:'..msg.chat_id_, result.sender_user_id_)
...
ChatKick(msg.chat_id_, result.id_)
Devhemo:sadd(BILLA..'hemo:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
Devhemo:sadd(BILLA..'hemo:Ban:'..msg.chat_id_, user)
...
Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_, result.id_)
...
Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_, user)
...
if not Constructor(msg) and Devhemo:get(BILLA.."hemo:Lock:MuteTked"..msg.chat_id_) then 
...
if Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⇇◍⇉هو بالفعل مكتوم من المجموعه")  
else
Devhemo:sadd(BILLA..'hemo:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⇇◍⇉هو بالفعل مكتوم من المجموعه")  
else
Devhemo:sadd(BILLA..'hemo:Muted:'..msg.chat_id_, result.id_)
...
if Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⇇◍⇉هو بالفعل مكتوم من المجموعه")  
else
Devhemo:sadd(BILLA..'hemo:Muted:'..msg.chat_id_, user)
...
if not Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⇇◍⇉هو ليس مكتوم لالغاء كتمه")  
else
Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","⇇◍⇉هو ليس مكتوم لالغاء كتمه")  
else
Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_, result.id_)
...
if not Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","⇇◍⇉هو ليس مكتوم لالغاء كتمه")  
else
Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_, user)
...
Devhemo:sadd(BILLA..'hemo:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
Devhemo:sadd(BILLA..'hemo:Tkeed:'..msg.chat_id_, result.id_)
...
Devhemo:sadd(BILLA..'hemo:Tkeed:'..msg.chat_id_, user)
...
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_, result.id_)
...
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_, user)
...
if Devhemo:sismember(BILLA..'hemo:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
Devhemo:sadd(BILLA..'hemo:BanAll:', result.sender_user_id_)
...
if Devhemo:sismember(BILLA..'hemo:SecondSudo:',result.id_) and not Sudo(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
Devhemo:sadd(BILLA..'hemo:BanAll:', result.id_)
...
if tonumber(user) == tonumber(BILLA) then  
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if Devhemo:sismember(BILLA..'hemo:SecondSudo:',user) and not Sudo(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉*لاتستطيع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
Devhemo:sadd(BILLA..'hemo:BanAll:', user)
...
Devhemo:sadd(BILLA..'hemo:MuteAll:', result.sender_user_id_)
...
if result.id_ then
Devhemo:sadd(BILLA..'hemo:MuteAll:', result.id_)
...
Devhemo:sadd(BILLA..'hemo:MuteAll:', user)
...
Devhemo:srem(BILLA..'hemo:BanAll:', result.sender_user_id_)
Devhemo:srem(BILLA..'hemo:MuteAll:', result.sender_user_id_)
...
if result.id_ then
Devhemo:srem(BILLA..'hemo:BanAll:', result.id_)
Devhemo:srem(BILLA..'hemo:MuteAll:', result.id_)
...
Devhemo:srem(BILLA..'hemo:BanAll:', user)
Devhemo:srem(BILLA..'hemo:MuteAll:', user)
...
Devhemo:setex(BILLA.."hemo:EditDev"..msg.sender_user_id_,300,true)
end
if Devhemo:get(BILLA.."hemo:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'⇇◍⇉تم الغاء امر تغير المطور الاساسي')
Devhemo:del(BILLA.."hemo:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
Devhemo:del(BILLA.."hemo:EditDev"..msg.sender_user_id_)
Devhemo:set(BILLA.."hemo:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source BILLA     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not Devhemo:get(BILLA..'hemo:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if Devhemo:sismember(BILLA..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⇇◍⇉هو مطي شرفع منه بعد😹??") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","⇇◍⇉تم رفعه في قائمة المطايه") 
Devhemo:sadd(BILLA..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source BILLA     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not Devhemo:get(BILLA..'hemo:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not Devhemo:sismember(BILLA..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","⇇◍⇉هو ليس مطي ليتم تنزيله") 
else
Devhemo:srem(BILLA..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
Devhemo:set('EngineerSource:'..BILLA..'id:user'..msg.chat_id_,TXT)  
Devhemo:setex('EngineerSource:'..BILLA.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
Devhemo:del(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
Devhemo:incrby(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
Devhemo:set('EngineerSource:'..BILLA..'ids:user'..msg.chat_id_,TXT)  
Devhemo:setex('EngineerSource:'..BILLA.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
Devhemo:incrby(BILLA..'hemo:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if Devhemo:get(BILLA..'hemo:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ then if msg.reply_to_message_id_ ~= 0 then Devhemo:sadd(BILLA.."hemo:cleaner"..msg.chat_id_, msg.id_) else Devhemo:sadd(BILLA.."hemo:cleaner"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if Devhemo:sismember(BILLA.."hemo:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
Devhemo:set(BILLA..'hemo:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = Devhemo:smembers(BILLA..'hemo:VipMem:'..msg.chat_id_)
text = "⇇◍⇉قائمة المميزين ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..hemo)
text = "⇇◍⇉قائمة الادمنيه ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:Managers:'..msg.chat_id_)
text = "⇇◍⇉قائمة المدراء ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:Cleaner:'..msg.chat_id_)
text = "⇇◍⇉قائمة المنظفين ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:Constructor:'..msg.chat_id_)
text = "⇇◍⇉قائمة المنشئين ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:hemoConstructor:'..msg.chat_id_)
text = "⇇◍⇉قائمة المالكين ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:BasicConstructor:'..msg.chat_id_)
...
local List = Devhemo:smembers(BILLA..'hemo:Muted:'..msg.chat_id_)
...
local List = Devhemo:smembers(BILLA..'hemo:Tkeed:'..msg.chat_id_)
text = "⇇◍⇉قائمة المقيدين ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:Ban:'..msg.chat_id_)
...
local List = Devhemo:hkeys(BILLA..'hemo:Filters:'..msg.chat_id_)
text = "⇇◍⇉قائمة المنع ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = Devhemo:smembers(BILLA..'User:Donky:'..msg.chat_id_)
...
local List = Devhemo:smembers(BILLA..'hemo:SecondSudo:')
...
local BanAll = Devhemo:smembers(BILLA..'hemo:BanAll:')
local MuteAll = Devhemo:smembers(BILLA..'hemo:MuteAll:')
if #BanAll ~= 0 then 
...
local List = Devhemo:smembers(BILLA..'hemo:SudoBot:')
text = "⇇◍⇉قائمة المطورين ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local sudouser = Devhemo:get(BILLA..'hemo:Sudos'..v) 
local username = Devhemo:get(BILLA..'Save:UserName'..v)
if username then
...
local List = Devhemo:smembers(BILLA..'hemo:ManagerAll:')
...
local List = Devhemo:smembers(BILLA..'hemo:VipAll:')
...
Devhemo:sadd(BILLA.."hemo:hemoConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
Devhemo:srem(BILLA.."hemo:FilterSteckr"..msg.chat_id_,idsticker)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
Devhemo:srem(BILLA.."hemo:FilterPhoto"..msg.chat_id_,photo)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
Devhemo:srem(BILLA.."hemo:FilterAnimation"..msg.chat_id_,idanimation)
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Thwel:hemo'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل تحويل الصيغ'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Thwel:hemo'..msg.chat_id_,true)  
end
if text == 'تحويل' and not Devhemo:get(BILLA..'hemo:Thwel:hemo'..msg.chat_id_) and ChCheck(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..data.id_) or 0)
if Devhemo:sismember(BILLA..'hemo:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif Devhemo:sismember(BILLA..'hemo:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif Devhemo:sismember(BILLA..'hemo:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif Devhemo:sismember(BILLA..'hemo:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if Devhemo:sismember(BILLA..'hemo:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n⇇◍⇉عدد الكروبات ↫ '..(Devhemo:get(BILLA..'hemo:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..res.id_) or 0)
if Devhemo:sismember(BILLA..'hemo:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif Devhemo:sismember(BILLA..'hemo:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif Devhemo:sismember(BILLA..'hemo:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif Devhemo:sismember(BILLA..'hemo:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if Devhemo:sismember(BILLA..'hemo:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n⇇◍⇉عدد الكروبات ↫ '..(Devhemo:get(BILLA..'hemo:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..iduser) or 0)
if Devhemo:sismember(BILLA..'hemo:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif Devhemo:sismember(BILLA..'hemo:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif Devhemo:sismember(BILLA..'hemo:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif Devhemo:sismember(BILLA..'hemo:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if Devhemo:sismember(BILLA..'hemo:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n⇇◍⇉عدد الكروبات ↫ '..(Devhemo:get(BILLA..'hemo:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if Devhemo:sismember(BILLA..'hemo:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if Devhemo:sismember(BILLA..'hemo:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if Devhemo:sismember(BILLA..'hemo:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if Devhemo:sismember(BILLA..'hemo:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if Devhemo:sismember(BILLA..'hemo:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if Devhemo:sismember(BILLA..'hemo:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if Devhemo:sismember(BILLA..'hemo:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if Devhemo:sismember(BILLA..'hemo:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if Devhemo:sismember(BILLA..'hemo:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉الحظر العام ↫ '..banall..'\n⇇◍⇉الكتم العام ↫ '..muteall..'\n⇇◍⇉الحظر ↫ '..banned..'\n⇇◍⇉الكتم ↫ '..muted..'\n⇇◍⇉التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_,result.sender_user_id_) Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_,result.sender_user_id_) Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_,result.sender_user_id_) Devhemo:srem(BILLA..'hemo:BanAll:',result.sender_user_id_) Devhemo:srem(BILLA..'hemo:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_,result.sender_user_id_) Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_,result.sender_user_id_) Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_,user) Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_,user) Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_,user) Devhemo:srem(BILLA..'hemo:BanAll:',user) Devhemo:srem(BILLA..'hemo:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_,user) Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_,user) Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_,result.id_) Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_,result.id_) Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_,result.id_) Devhemo:srem(BILLA..'hemo:BanAll:',result.id_) Devhemo:srem(BILLA..'hemo:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_,result.id_) Devhemo:srem(BILLA..'hemo:Ban:'..msg.chat_id_,result.id_) Devhemo:srem(BILLA..'hemo:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
Devhemo:set(BILLA.."hemo:GpIds:Text"..msg.chat_id_,Text_Rand)
...
Devhemo:set("BILLA:New:id:"..BILLA..msg.sender_user_id_,'EngineerSource')
return "EngineerSource"
end
if text and Devhemo:get("BILLA:New:id:"..BILLA..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ كليشة الايدي', 1, 'md')
Devhemo:del("BILLA:New:id:"..BILLA..msg.sender_user_id_)
return false
end
Devhemo:del("BILLA:New:id:"..BILLA..msg.sender_user_id_)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حفظ كليشة الايدي العامه', 1, 'md')
Devhemo:set(BILLA.."hemo:AllIds:Text",text)
return false
end
...
Devhemo:del(BILLA.."hemo:AllIds:Text")
end
end
--     Source BILLA     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉رجائا اتبع التعليمات للتعيين \n⇇◍⇉لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺', 1, 'md')
Devhemo:set("BILLA:New:id:"..BILLA..msg.chat_id_..msg.sender_user_id_,'EngineerSource')
return "EngineerSource"
end
if text and Manager(msg) and Devhemo:get("BILLA:New:id:"..BILLA..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ كليشة الايدي', 1, 'md')
Devhemo:del("BILLA:New:id:"..BILLA..msg.chat_id_..msg.sender_user_id_)
return false
end
Devhemo:del("BILLA:New:id:"..BILLA..msg.chat_id_..msg.sender_user_id_)
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم حفظ الكليشه الجديده', 1, 'md')
Devhemo:set(BILLA.."hemo:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم حذف كليشة الايدي")  
Devhemo:del(BILLA.."hemo:GpIds:Text"..msg.chat_id_)
end
end
--     Source BILLA     --
if msg.reply_to_message_id_ ~= 0 then
...
local msgsday = Devhemo:get(BILLA..'hemo:UsersMsgs'..BILLA..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = Devhemo:get(BILLA..'hemo:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = Devhemo:get(BILLA..'hemo:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(Devhemo:get(BILLA..'hemo:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(Devhemo:get(BILLA..'hemo:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not Devhemo:get(BILLA..'hemo:Lock:Id'..msg.chat_id_) then 
if not Devhemo:get(BILLA..'hemo:Lock:Id:Photo'..msg.chat_id_) then 
if Devhemo:get(BILLA.."hemo:AllIds:Text") then
newpicid = Devhemo:get(BILLA.."hemo:AllIds:Text")
...
if not Devhemo:get(BILLA.."hemo:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, abbas.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = Devhemo:get(BILLA.."hemo:GpIds:Text"..msg.chat_id_)
...
if Devhemo:get(BILLA.."hemo:AllIds:Text") then
newallid = Devhemo:get(BILLA.."hemo:AllIds:Text")
...
if Devhemo:get(BILLA.."hemo:AllIds:Text") then
notpicid = Devhemo:get(BILLA.."hemo:AllIds:Text")
...
if not Devhemo:get(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم قفل التعديل")  
Devhemo:set(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_,true)
else
...
Devhemo:set(BILLA.."hemo:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم قفل البوتات بالطرد")  
Devhemo:set(BILLA.."hemo:Lock:Bots"..msg.chat_id_,"kick")  
end
...
Devhemo:set(BILLA.."hemo:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not Devhemo:get(BILLA..'hemo:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  Devhemo:set(BILLA.."hemo:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم قفل التثبيت")  
Devhemo:set(BILLA..'hemo:Lock:Pin'..msg.chat_id_,true)
Devhemo:sadd(BILLA.."hemo:Lock:Pinpin",msg.chat_id_) 
else
...
Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if Devhemo:get(BILLA..'hemo:Lock:Id:Photo'..msg.chat_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الايدي بالصوره'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if Devhemo:get(BILLA..'hemo:Lock:Id'..msg.chat_id_) then
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉الايدي بالتاكيد معطل ', 1, 'md')
else
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الايدي بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source BILLA     --
...
Devhemo:setex(BILLA.."hemo:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' or text == 'انشاء الرابط' then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not Devhemo:get(BILLA.."hemo:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
Devhemo:set(BILLA.."hemo:Groups:Links"..msg.chat_id_,LinkGroup) 
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA.."hemo:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الترحيب بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA.."hemo:Lock:Welcome"..msg.chat_id_)
end
if Devhemo:get(BILLA..'hemo:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ كليشة الترحيب', 1, 'md')
Devhemo:del(BILLA..'hemo:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
Devhemo:del(BILLA..'hemo:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
Devhemo:set(BILLA..'hemo:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
Devhemo:set(BILLA..'hemo:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم حذف الترحيب")  
Devhemo:del(BILLA..'hemo:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = Devhemo:get(BILLA..'hemo:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_hemo(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source BILLA     --
if Devhemo:get(BILLA..'hemo:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء حفظ الوصف", 1, 'md')
Devhemo:del(BILLA..'hemo:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
Devhemo:del(BILLA..'hemo:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
Devhemo:set(BILLA..'hemo:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
Devhemo:set(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if Devhemo:get(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر المنع', 1, 'md')
Devhemo:del(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم منع الكلمه ↫ "..text, 1, 'html')
Devhemo:del(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
Devhemo:hset(BILLA..'hemo:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉ارسل لي الكلمه الان", 1, 'md') 
Devhemo:set(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if Devhemo:get(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر الغاء المنع', 1, 'md')
Devhemo:del(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not Devhemo:hget(BILLA..'hemo:Filters:'..msg.chat_id_, text) then  
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
Devhemo:del(BILLA.."hemo:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
Devhemo:hdel(BILLA..'hemo:Filters:'..msg.chat_id_, text)
...
local gps = Devhemo:scard(BILLA.."hemo:Groups") local users = Devhemo:scard(BILLA.."hemo:Users") 
...
local users = Devhemo:scard(BILLA.."hemo:Users")
...
local gps = Devhemo:scard(BILLA.."hemo:Groups")
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     Source BILLA     --
if text and text:match('^تنظيف (%d+)$') and ChCheck(msg) then  
if not Devhemo:get(BILLA..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
Devhemo:setex(BILLA..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
if text == "تنظيف المشتركين" and SecondSudo(msg) and ChCheck(msg) then 
local pv = Devhemo:smembers(BILLA.."hemo:Users")
local sendok = 0
for i = 1, #pv do
...
Devhemo:srem(BILLA.."hemo:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = Devhemo:smembers(BILLA.."hemo:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
Devhemo:srem(BILLA.."hemo:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = BILLA, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_hemo(msg.chat_id_, msg.id_, 1,'⇇◍⇉عدد الكروبات الان ↫ { '..#group..' }'..BILLAgp1..BILLAgp2..'\n⇇◍⇉العدد الحقيقي الان  ↫ ( '..BILLAgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:Clean'..msg.chat_id_,true)  
end
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:Clean'..msg.chat_id_) 
end
...
Devhemo:set(BILLA..'hemo:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and Devhemo:get(BILLA..'hemo:Lock:Clean'..msg.chat_id_) then
if Devhemo:get(BILLA..'hemo:CleanNum'..msg.chat_id_) then CleanNum = Devhemo:get(BILLA..'hemo:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if Devhemo:scard(BILLA.."hemo:cleaner"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = Devhemo:smembers(BILLA.."hemo:cleaner"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
...
Devhemo:del(BILLA.."hemo:cleaner"..msg.chat_id_)
end 
end 
if Cleaner(msg) then
if Devhemo:get(BILLA..'hemo:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = Devhemo:scard(BILLA.."hemo:cleaner"..msg.chat_id_)
if M ~= 0 then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉عدد الميديا ↫ "..M.."\n⇇◍⇉الحذف التلقائي ↫ "..(Devhemo:get(BILLA..'hemo:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
if Devhemo:get(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم فتح التعديل")  
Devhemo:del(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_)
else
...
Devhemo:del(BILLA.."hemo:Lock:Bots"..msg.chat_id_)  
end
if UnLockText[2] == "التكرار" then 
Devhemo:hdel(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if Devhemo:get(BILLA..'hemo:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم فتح التثبيت")  
Devhemo:del(BILLA..'hemo:Lock:Pin'..msg.chat_id_)
Devhemo:srem(BILLA.."hemo:Lock:Pinpin",msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Text'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Photo'..msg.chat_id_)
else
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if Devhemo:get(BILLA..'hemo:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم فتح الكلايش")  
Devhemo:del(BILLA..'hemo:Lock:Spam'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Join'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Videos'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Document'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Inline'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Markdown'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Gifs'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Music'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Voice'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Links'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Location'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Tags'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Hashtak'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Contact'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:WebLinks'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Arabic'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:English'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:TagServr'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Stickers'..msg.chat_id_)
else
...
Devhemo:del(BILLA..'hemo:Lock:Forwards'..msg.chat_id_)
else
...
Devhemo:set(BILLA.."hemo:Lock:Bots"..msg.chat_id_,"del") Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'hemo:Lock:Links','hemo:Lock:Contact','hemo:Lock:Forwards','hemo:Lock:Videos','hemo:Lock:Gifs','hemo:Lock:EditMsgs','hemo:Lock:Stickers','hemo:Lock:Farsi','hemo:Lock:Spam','hemo:Lock:WebLinks','hemo:Lock:Photo'}
for i,Lock in pairs(LockList) do
Devhemo:set(BILLA..Lock..msg.chat_id_,true)
end
...
Devhemo:del(BILLA..UnLock..msg.chat_id_)
end
...
Devhemo:del(BILLA..'hemo:Lock:Fshar'..msg.chat_id_) Devhemo:del(BILLA..'hemo:Lock:Taf'..msg.chat_id_) Devhemo:del(BILLA..'hemo:Lock:Kfr'..msg.chat_id_) 
Devhemo:set(BILLA.."hemo:Lock:Bots"..msg.chat_id_,"del") Devhemo:hset(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
Devhemo:set(BILLA..'hemo:Lock:Fshar'..msg.chat_id_,true) Devhemo:set(BILLA..'hemo:Lock:Taf'..msg.chat_id_,true) Devhemo:set(BILLA..'hemo:Lock:Kfr'..msg.chat_id_,true) Devhemo:hdel(BILLA.."hemo:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
Devhemo:set(BILLA..'hemo:Spam:Text'..msg.chat_id_,SetSpam)
...
Devhemo:del(BILLA.."hemo:mem:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:Cleaner:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:VipMem:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:Admins:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:Managers:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:Constructor:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:BasicConstructor:Rd"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source BILLA     --
...
if tonumber(admins[i].user_id_) ~= tonumber(BILLA) then
...
Devhemo:del(BILLA..'hemo:AdminAll:')
end
...
Devhemo:del(BILLA..'hemo:ManagerAll:')
end
if txts[2] == 'المالكين' or txtss[2] == 'المالكين' then
Devhemo:del(BILLA..'hemo:hemoConstructor:'..msg.chat_id_)
...
Devhemo:del(BILLA..'hemo:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم حذف المنشئين")  
Devhemo:del(BILLA..'hemo:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم حذف المدراء")  
Devhemo:del(BILLA..'hemo:Managers:'..msg.chat_id_)
end 
...
Devhemo:srem(BILLA..'hemo:Tkeed:'..msg.chat_id_, v)
end 
...
Devhemo:del(BILLA..'hemo:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","⇇◍⇉تم حذف قوائم المنع")  
Devhemo:del(BILLA..'hemo:Filters:'..msg.chat_id_)
Devhemo:del(BILLA.."hemo:FilterAnimation"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:FilterPhoto"..msg.chat_id_)
Devhemo:del(BILLA.."hemo:FilterSteckr"..msg.chat_id_)
end
...
Devhemo:del(BILLA..'hemo:Ban:'..msg.chat_id_) Devhemo:del(BILLA..'hemo:Admins:'..msg.chat_id_) Devhemo:del(BILLA..'User:Donky:'..msg.chat_id_) Devhemo:del(BILLA..'hemo:VipMem:'..msg.chat_id_) Devhemo:del(BILLA..'hemo:Filters:'..msg.chat_id_) Devhemo:del(BILLA..'hemo:Muted:'..msg.chat_id_)
...
local basicconstructor = Devhemo:smembers(BILLA..'hemo:BasicConstructor:'..msg.chat_id_)
local constructor = Devhemo:smembers(BILLA..'hemo:Constructor:'..msg.chat_id_)
local Managers = Devhemo:smembers(BILLA..'hemo:Managers:'..msg.chat_id_)
local admins = Devhemo:smembers(BILLA..'hemo:Admins:'..msg.chat_id_)
local vipmem = Devhemo:smembers(BILLA..'hemo:VipMem:'..msg.chat_id_)
local donky = Devhemo:smembers(BILLA..'User:Donky:'..msg.chat_id_)
...
spam_c = Devhemo:get(BILLA..'hemo:Spam:Text'..msg.chat_id_)
end
--     Source BILLA     --
if Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source BILLA     --
if Devhemo:get(BILLA.."hemo:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif Devhemo:get(BILLA.."hemo:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif Devhemo:get(BILLA.."hemo:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source BILLA     --
if Devhemo:get(BILLA..'hemo:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if Devhemo:get(BILLA..'hemo:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if Devhemo:get(BILLA.."hemo:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if Devhemo:get(BILLA..'hemo:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if Devhemo:get(BILLA..'hemo:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if Devhemo:get(BILLA..'hemo:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if Devhemo:get(BILLA..'hemo:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = Devhemo:hget(BILLA.."hemo:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source BILLA     --
...
--     Source BILLA     --
if Devhemo:get(BILLA..'hemo:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء حفظ قوانين المجموعه', 1, 'md')
Devhemo:del(BILLA..'hemo:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
Devhemo:del(BILLA..'hemo:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:rules'..msg.chat_id_,text)
...
Devhemo:set(BILLA..'hemo:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") then
local rules = Devhemo:get(BILLA..'hemo:rules'..msg.chat_id_)
...
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل ميزة انطق'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Antk:hemo'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل ميزة انطق'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Antk:hemo'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not Devhemo:get(BILLA..'hemo:Antk:hemo'..msg.chat_id_) and ChCheck(msg) then
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Zrf:hemo'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الزخرفه بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Zrf:hemo'..msg.chat_id_,true)  
end
if Devhemo:get(BILLA..'Zrf:hemo'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر الزخرفه', 1, 'md')
Devhemo:del(BILLA..'Zrf:hemo'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not Devhemo:get(BILLA..'hemo:Zrf:hemo'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
Devhemo:setex(BILLA.."Zrf:hemo"..msg.chat_id_..msg.sender_user_id_,300,true)
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Brg:hemo'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الابراج بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Brg:hemo'..msg.chat_id_,true)  
end
if not Devhemo:get(BILLA..'hemo:Brg:hemo'..msg.chat_id_) then
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Nsba:hemo'..msg.chat_id_) 
end
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Nsba:hemo'..msg.chat_id_,true)  
end
if not Devhemo:get(BILLA..'hemo:Nsba:hemo'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
Devhemo:set(BILLA..'LoveNsba:hemo'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and Devhemo:get(BILLA..'LoveNsba:hemo'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر نسبة الحب ', 1, 'md')
Devhemo:del(BILLA..'LoveNsba:hemo'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
Devhemo:set(BILLA..'HataNsba:hemo'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and Devhemo:get(BILLA..'HataNsba:hemo'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر نسبة الكره ', 1, 'md')
Devhemo:del(BILLA..'HataNsba:hemo'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
hemo = math.random(0,100);
...
Devhemo:set(BILLA..'RjolaNsba:hemo'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and Devhemo:get(BILLA..'RjolaNsba:hemo'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر نسبة الرجوله ', 1, 'md')
Devhemo:del(BILLA..'RjolaNsba:hemo'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
hemo = math.random(0,100);
...
Devhemo:set(BILLA..'AnothaNsba:hemo'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and Devhemo:get(BILLA..'AnothaNsba:hemo'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر نسبة الانوثه ', 1, 'md')
Devhemo:del(BILLA..'AnothaNsba:hemo'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
hemo = math.random(0,100);
...
Devhemo:set(BILLA..'StupidNsba:hemo'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and Devhemo:get(BILLA..'StupidNsba:hemo'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, '⇇◍⇉تم الغاء امر نسبة الغباء ', 1, 'md')
Devhemo:del(BILLA..'StupidNsba:hemo'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
hemo = math.random(0,100);
...
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل حساب العمر'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Age:hemo'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل حساب العمر'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Age:hemo'..msg.chat_id_,true)  
end
if not Devhemo:get(BILLA..'hemo:Age:hemo'..msg.chat_id_) then
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Mean:hemo'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل معاني الاسماء'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Mean:hemo'..msg.chat_id_,true)  
end
if not Devhemo:get(BILLA..'hemo:Mean:hemo'..msg.chat_id_) then
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Audios:hemo'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل غنيلي بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Audios:hemo'..msg.chat_id_,true)  
end
if text == "غنيلي" and not Devhemo:get(BILLA..'hemo:Audios:hemo'..msg.chat_id_) and ChCheck(msg) then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◍ BILLA TeAM .',url="t.me/ba8lawa"}},
}
local msg_id = msg.id_/2097152/0.5
...
--     Source BILLA     --
if Admin(msg) then
if Devhemo:get(BILLA..'hemo:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if Devhemo:get(BILLA..'hemo:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الروابط ↫ "..mute_links.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if Devhemo:get(BILLA..'hemo:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉المعرف ↫ "..lock_tag.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if Devhemo:get(BILLA..'hemo:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉المتحركه ↫ "..mute_gifs.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الملصقات" then if Devhemo:get(BILLA..'hemo:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الملصقات ↫ "..lock_sticker.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الصور" then if Devhemo:get(BILLA..'hemo:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الصور ↫ "..mute_photo.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if Devhemo:get(BILLA..'hemo:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الفيديو ↫ "..mute_video.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الاونلاين" then if Devhemo:get(BILLA..'hemo:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉الاونلاين ↫ "..mute_in.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الدردشه" then if Devhemo:get(BILLA..'hemo:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الدردشه ↫ "..mute_text.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if Devhemo:get(BILLA..'hemo:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉التوجيه ↫ "..lock_forward.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الاغاني" then if Devhemo:get(BILLA..'hemo:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الاغاني ↫ "..mute_music.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if Devhemo:get(BILLA..'hemo:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉الصوت ↫ "..mute_voice.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if Devhemo:get(BILLA..'hemo:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الجهات ↫ "..lock_contact.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الماركداون" then if Devhemo:get(BILLA..'hemo:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉الماركداون ↫ "..markdown.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الهاشتاك" then if Devhemo:get(BILLA..'hemo:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉الهاشتاك ↫ "..lock_htag.."\n"Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "التعديل" then if Devhemo:get(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉التعديل ↫ "..mute_edit.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "التثبيت" then if Devhemo:get(BILLA..'hemo:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉التثبيت ↫ "..lock_pin.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الاشعارات" then if Devhemo:get(BILLA..'hemo:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الاشعارات ↫ "..lock_tgservice.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الكلايش" then if Devhemo:get(BILLA..'hemo:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الكلايش ↫ "..lock_spam.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الدخول" then if Devhemo:get(BILLA..'hemo:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local EngineerSource = "\n" .."⇇◍⇉الدخول ↫ "..lock_Join.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الشبكات" then if Devhemo:get(BILLA..'hemo:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الشبكات ↫ "..lock_wp.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "المواقع" then if Devhemo:get(BILLA..'hemo:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉المواقع ↫ "..lock_location.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "العربيه" then if Devhemo:get(BILLA..'hemo:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉العربيه ↫ "..lock_arabic.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الانكليزيه" then if Devhemo:get(BILLA..'hemo:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local EngineerSource = "\n" .."⇇◍⇉الانكليزيه ↫ "..lock_english.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الكفر" then if Devhemo:get(BILLA..'hemo:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local EngineerSource = "\n" .."⇇◍⇉الكفر ↫ "..lock_kaf.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الفشار" then if Devhemo:get(BILLA..'hemo:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local EngineerSource = "\n" .."⇇◍⇉الفشار ↫ "..lock_fshar.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
if text == "الطائفيه" then if Devhemo:get(BILLA..'hemo:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local EngineerSource = "\n" .."⇇◍⇉الطائفيه ↫ "..lock_taf.."\n" Dev_hemo(msg.chat_id_, msg.id_, 1, EngineerSource, 1, 'md') end
end
--     Source BILLA     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل كشف الاعدادات'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل كشف الاعدادات'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:LockSettings'..msg.chat_id_) 
end
--     Source BILLA     --
if text == 'تفعيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل اوامر التحشيش'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:Stupid'..msg.chat_id_)
end
if text == 'تعطيل اوامر التحشيش' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل اوامر التحشيش'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:Stupid'..msg.chat_id_,true)
end
--     Source BILLA     --
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:Robot'..msg.chat_id_)
end
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:Robot'..msg.chat_id_,true)
end
--     Source BILLA     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل ردود المدير'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل ردود المدير'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:GpRed'..msg.chat_id_,true)
end
--     Source BILLA     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل ردود المطور'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل ردود المطور'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:AllRed'..msg.chat_id_,true)
end
--     Source BILLA     --
if SecondSudo(msg) then
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA.."hemo:Left:Bot"..BILLA)
end
if text == 'تعطيل المغادره' or text == '↫ تعطيل المغادره ◍' then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل المغادره بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA.."hemo:Left:Bot"..BILLA,true) 
end 
if text == 'تفعيل الاذاعه' or text == '↫ تفعيل الاذاعه ◍' then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل الاذاعه بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA.."hemo:Send:Bot"..BILLA)
end
if text == 'تعطيل الاذاعه' or text == '↫ تعطيل الاذاعه ◍' then 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الاذاعه بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA.."hemo:Send:Bot"..BILLA,true) 
end
end
--     Source BILLA     --
...
--     Source BILLA     --
if msg.content_.photo_ then
if Devhemo:get(BILLA..'hemo:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
Devhemo:del(BILLA..'hemo:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"⇇◍⇉ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
Devhemo:del(BILLA..'hemo:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
Devhemo:set(BILLA..'hemo:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source BILLA     --
...
if data.ID == "Ok" then
Devhemo:del(BILLA..'hemo:PinnedMsg'..msg.chat_id_)
...
local PinId = Devhemo:get(BILLA..'hemo:PinnedMsg'..msg.chat_id_)
if PinId then
...
Devhemo:del(BILLA..'hemo:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = Devhemo:scard(BILLA.."hemo:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = Devhemo:scard(BILLA.."hemo:Constructor:"..ChatId) or 0
local BanedList = Devhemo:scard(BILLA.."hemo:Ban:"..ChatId) or 0
local ManagerList = Devhemo:scard(BILLA.."hemo:Managers:"..ChatId) or 0
local MutedList = Devhemo:scard(BILLA.."hemo:Muted:"..ChatId) or 0
local TkeedList = Devhemo:scard(BILLA.."hemo:hemo:Tkeed:"..ChatId) or 0
local AdminsList = Devhemo:scard(BILLA.."hemo:Admins:"..ChatId) or 0
local VipList = Devhemo:scard(BILLA.."hemo:VipMem:"..ChatId) or 0
...
ChatLeave(dp.id_, BILLA)
Devhemo:srem(BILLA.."hemo:Groups", dp.id_)
else
...
Devhemo:set(BILLA..'hemo:Num:Add:Bot',Num) 
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:FreeBot'..BILLA) 
end 
end
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:FreeBot'..BILLA,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA..'hemo:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تعطيل الالعاب بنجاح'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA..'hemo:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم تفعيل جلب رابط المجموعه'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:del(BILLA.."hemo:Lock:GpLinks"..msg.chat_id_)
return false  
end
end
...
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
Devhemo:set(BILLA.."hemo:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
--     Source BILLA     --
...
ReplyStatus(msg,result.id_,"ReplyBy","⇇◍⇉تم تفعيل المجموعه "..dp.title_)  
Devhemo:sadd(BILLA.."hemo:Groups",msg.chat_id_)
if not Devhemo:get(BILLA..'hemo:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
Devhemo:incrby(BILLA..'hemo:Sudos'..msg.sender_user_id_,1)
Devhemo:set(BILLA..'hemo:SudosGp'..msg.sender_user_id_..msg.chat_id_,"hemo")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not Devhemo:sismember(BILLA..'hemo:Groups',msg.chat_id_) then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './BILLA.lua', '⇇◍⇉نسخة ملف سورس بيلاا',dl_cb, nil)
end end
--     Source BILLA     --
...
local Text = "⇇◍⇉Source BILLA\n⇇◍⇉File Bot Groups\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n"
for k,v in pairs(List) do
local GroupsManagers = Devhemo:scard(BILLA.."hemo:Managers:"..v) or 0
local GroupsAdmins = Devhemo:scard(BILLA.."hemo:Admins:"..v) or 0
local Groupslink = Devhemo:get(BILLA.."hemo:Groups:Links" ..v)
...
Devhemo:setex(BILLA.."hemo:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⇇◍⇉للخروج ارسل ↫ ( الغاء ) \n ✓'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
return false
end 
if Devhemo:get(BILLA.."hemo:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء امر الاذاعه بنجاح", 1, 'md')
Devhemo:del(BILLA.."hemo:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = Devhemo:smembers(BILLA..'hemo:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
hemoText = "الرساله"
...
Devhemo:setex(BILLA.."hemo:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⇇◍⇉للخروج ارسل ↫ ( الغاء ) \n ✓'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
return false
end 
if Devhemo:get(BILLA.."hemo:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء امر الاذاعه بنجاح", 1, 'md')
Devhemo:del(BILLA.."hemo:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = Devhemo:smembers(BILLA..'hemo:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
hemoText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
Devhemo:setex(BILLA.."hemo:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉ارسل الرساله الان لتوجيها \n⇇◍⇉للخروج ارسل ↫ ( الغاء ) \n ✓'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
return false
end 
if Devhemo:get(BILLA.."hemo:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء امر الاذاعه بنجاح", 1, 'md')
Devhemo:del(BILLA.."hemo:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = Devhemo:smembers(BILLA..'hemo:Groups')   
for k,v in pairs(List) do  
...
Devhemo:setex(BILLA.."hemo:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉ارسل الرساله الان لتوجيها \n⇇◍⇉للخروج ارسل ↫ ( الغاء ) \n ✓'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
return false
end 
if Devhemo:get(BILLA.."hemo:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء امر الاذاعه بنجاح", 1, 'md')
Devhemo:del(BILLA.."hemo:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = Devhemo:smembers(BILLA..'hemo:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم اذاعة رسالتك بالتوجيه \n⇇◍⇉‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
Devhemo:setex(BILLA.."hemo:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⇇◍⇉للخروج ارسل ↫ ( الغاء ) \n ✓'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
return false
end 
if Devhemo:get(BILLA.."hemo:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء امر الاذاعه بنجاح", 1, 'md')
Devhemo:del(BILLA.."hemo:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = Devhemo:smembers(BILLA.."hemo:Groups") 
if msg.content_.text_ then
...
hemoText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
hemoText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
hemoText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
hemoText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
hemoText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
hemoText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
hemoText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
hemoText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
Devhemo:set(BILLA..'hemo:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
local List = Devhemo:smembers(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end
Devhemo:set(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = Devhemo:get(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not Devhemo:sismember(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_,text) then
...
Devhemo:set(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
Devhemo:set(BILLA..'hemo:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
Devhemo:set(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل الكلمه لحذفها" ,  1, "md")
return false
end
if text == 'اضف رد متعدد' and Manager(msg) and ChCheck(msg) then
Devhemo:set(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل الكلمه الان" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRedod = Devhemo:get(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
Devhemo:set(BILLA..'hemo:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
Devhemo:set(BILLA..'hemo:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
Devhemo:sadd(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source BILLA     --
if text == 'حذف رد' and Manager(msg) and ChCheck(msg) or text == 'مسح رد' and  Manager(msg) and ChCheck(msg) then
local List = Devhemo:smembers(BILLA..'hemo:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉لا توجد ردود مضافه" ,  1, "md")
return false
end
Devhemo:set(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد' and Manager(msg) and ChCheck(msg) then
Devhemo:set(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = Devhemo:get(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
Devhemo:set(BILLA..'hemo:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
Devhemo:set(BILLA..'hemo:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
Devhemo:sadd(BILLA..'hemo:Manager:GpRed'..msg.chat_id_,text)
Devhemo:set(BILLA..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source BILLA     --
if text == 'حذف رد عام' and SecondSudo(msg) or text == '↫ حذف رد عام ◍' and SecondSudo(msg) or text == 'مسح رد عام' and SecondSudo(msg) then
local List = Devhemo:smembers(BILLA.."hemo:Sudo:AllRed")
if #List == 0 then
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉لا توجد ردود مضافه" ,  1, "md")
return false
end
Devhemo:set(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
if text == 'اضف رد عام' and SecondSudo(msg) or text == '↫ اضف رد عام ◍' and SecondSudo(msg) then
Devhemo:set(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetAllRed = Devhemo:get(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_)
...
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n⇇◍⇉يمكنك اضافة الى النص ↫ ⤈\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n⇇◍⇉للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
Devhemo:set(BILLA.."hemo:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
Devhemo:set(BILLA.."hemo:Add:AllText"..msg.sender_user_id_, text)
Devhemo:sadd(BILLA.."hemo:Sudo:AllRed",text)
Devhemo:set(BILLA.."DelSudoRep",text)
return false 
end end
--     Source BILLA     --
if text == 'الردود المتعدده' and Manager(msg) and ChCheck(msg) then
local redod = Devhemo:smembers(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_)
MsgRep = '⇇◍⇉قائمة الردود المتعدده ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#Devhemo:smembers(BILLA..'hemo:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
for k,v in pairs(redod) do
Devhemo:del(BILLA..'hemo:Text:GpTexts'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = Devhemo:smembers(BILLA..'hemo:Manager:GpRed'..msg.chat_id_)
MsgRep = '⇇◍⇉ردود المدير ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n'
for k,v in pairs(redod) do
if Devhemo:get(BILLA.."hemo:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif Devhemo:get(BILLA.."hemo:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif Devhemo:get(BILLA.."hemo:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif Devhemo:get(BILLA.."hemo:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif Devhemo:get(BILLA.."hemo:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif Devhemo:get(BILLA.."hemo:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif Devhemo:get(BILLA.."hemo:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif Devhemo:get(BILLA.."hemo:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
Devhemo:del(BILLA..'hemo:Gif:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Voice:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Audio:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Photo:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Stecker:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Video:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:File:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Text:GpRed'..v..msg.chat_id_)
Devhemo:del(BILLA..'hemo:Manager:GpRed'..msg.chat_id_)
end
...
local redod = Devhemo:smembers(BILLA.."hemo:Sudo:AllRed")
MsgRep = '⇇◍⇉ردود المطور ↫ ⤈ \n⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺\n'
for k,v in pairs(redod) do
if Devhemo:get(BILLA.."hemo:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif Devhemo:get(BILLA.."hemo:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif Devhemo:get(BILLA.."hemo:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif Devhemo:get(BILLA.."hemo:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif Devhemo:get(BILLA.."hemo:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif Devhemo:get(BILLA.."hemo:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif Devhemo:get(BILLA.."hemo:File:AllRed"..v) then
dp = 'ملف 📁'
elseif Devhemo:get(BILLA.."hemo:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
Devhemo:del(BILLA.."hemo:Add:AllRed"..v)
Devhemo:del(BILLA.."hemo:Gif:AllRed"..v)
Devhemo:del(BILLA.."hemo:Voice:AllRed"..v)
Devhemo:del(BILLA.."hemo:Audio:AllRed"..v)
Devhemo:del(BILLA.."hemo:Photo:AllRed"..v)
Devhemo:del(BILLA.."hemo:Stecker:AllRed"..v)
Devhemo:del(BILLA.."hemo:Video:AllRed"..v)
Devhemo:del(BILLA.."hemo:File:AllRed"..v)
Devhemo:del(BILLA.."hemo:Text:AllRed"..v)
Devhemo:del(BILLA.."hemo:Sudo:AllRed")
end
...
Devhemo:set(BILLA..'hemo:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
Devhemo:del(BILLA..'hemo:NameBot')
local EngineerSource = '⇇◍⇉اهلا عزيزي ↫ '..hemoRank(msg)..' \n⇇◍⇉تم حذف اسم البوت'
hemomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, EngineerSource, 14, string.len(msg.sender_user_id_))
end end 
--     Source BILLA     --
...
Devhemo:set(BILLA..'hemo:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help0'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help0'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
Devhemo:set(BILLA..'hemo:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help01'..msg.sender_user_id_)
if EngineerSource == 'msg' then 
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help01'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help1', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
Devhemo:set(BILLA..'hemo:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help21'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help21'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help2', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
Devhemo:set(BILLA..'hemo:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help31'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help31'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help3', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
Devhemo:set(BILLA..'hemo:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help41'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help41'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help4', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
Devhemo:set(BILLA..'hemo:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help51'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help51'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help5', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
Devhemo:set(BILLA..'hemo:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local EngineerSource =  Devhemo:get(BILLA..'hemo:Help61'..msg.sender_user_id_)
if EngineerSource == 'msg' then
Dev_hemo(msg.chat_id_, msg.id_, 1, text , 1, 'md')
Devhemo:del(BILLA..'hemo:Help61'..msg.sender_user_id_)
Devhemo:set(BILLA..'hemo:Help6', text)
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/BILLATEAM/Files_BILLA/main/File_Bot/"..FileName)
if Res == 200 then
...
Devhemo:del(BILLA..'hemo:Text:BotWelcome')
Devhemo:del(BILLA..'hemo:Photo:BotWelcome')
return false
end 
...
Devhemo:del(BILLA..'hemo:Lock:BotWelcome')
return false
end 
...
Devhemo:set(BILLA..'hemo:Lock:BotWelcome',true)
return false
end 
...
Devhemo:del(BILLA..'hemo:Text:BotWelcome')
Devhemo:del(BILLA..'hemo:Photo:BotWelcome')
Devhemo:set(BILLA.."hemo:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and Devhemo:get(BILLA.."hemo:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء الامر", 1, "md") 
Devhemo:del(BILLA.."hemo:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم حفظ النص ارسل لي صورة الترحيب\n⇇◍⇉ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
Devhemo:set(BILLA.."hemo:Text:BotWelcome",text) 
Devhemo:set(BILLA.."hemo:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if Devhemo:get(BILLA.."hemo:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
Devhemo:set(BILLA.."hemo:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
Devhemo:setex(BILLA.."hemo:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
Devhemo:del(BILLA.."DevText")
end end
--     Source BILLA     --
if Devhemo:get(BILLA.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_hemo(msg.chat_id_, msg.id_, 1, "⇇◍⇉تم الغاء الامر", 1, "md") 
Devhemo:del(BILLA.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
Devhemo:del(BILLA.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
Devhemo:set(BILLA..'hemo:ChText',texxt)
...
Devhemo:setex(BILLA.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
Devhemo:incr(BILLA..'hemo:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if Devhemo:get(BILLA..'hemo:Lock:EditMsgs'..msg.chat_id_) and not Text and not BasicConstructor(result) then
...
local GetMsgPin = Devhemo:get(BILLA..'hemo:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;Devhemo:del(BILLA..'hemo:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) Devhemo:del(BILLA..'hemo:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=BILLA,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
Devhemo:srem(BILLA..'hemo:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
Devhemo:srem(BILLA..'hemo:Groups',v)  
end
...
Devhemo:sadd(BILLA..'hemo:Groups',v)  
end end,nil) end
end
--     Source BILLA     --
end 
